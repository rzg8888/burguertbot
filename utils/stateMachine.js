      ...
      states: {
          ...
          states: {
              ...
              states: {
                ...
                "prompt-for-payment": {
                  onEntry: (context) => {
                    ...
                    paymentPrompt += `💰 *Monto Total:* S/.${total.toFixed(
                      2
                    )}\n\n`;
                ...
                "prompt-for-order-confirmation": {
                  ...
                  onEntry: (context) => {
                    ...
                    const fixedTotal = subtotal.toFixed(2);
            ...
            "connect-with-a-human": {
              onEntry: async (context) => {
                ...
                //for the user
                const connectWithHumanPrompt = `🤖 Estoy aquí para ayudarte! Si quieres hablar con un humano, te estamos contactando con uno.\n\nNuestro equipo está preparado para resolver cualquier duda en tu proceso de compra.\n\nPor favor espera un momento mientras te conectamos con un agente disponible. 🙋‍♂️🙋‍♀️`;
                const nextLine = `Por favor ten en cuenta que durante periodos de mayor pedido el contacto con uno de nuestro agentes puede demorar un poco más. Agradeceremos tu paciencia!🕒🙂🍕`;
                flowDynamic([connectWithHumanPrompt, nextLine]);

                //for the agent
                const agentPhoneNumber = "51998363046@s.whatsapp.net"; //1234567890 should be replaced with the agent's phone number
                const agentMessage = `🔔🆕 Un cliente está a la espera de respuesta, ${
                  ctx.pushName
                }, necesita soporte. Estos son los detalles de contacto:\n\n*Nombre:* ${
                  ctx.pushName
                }\n*Contacto Directo:* wa.me/${
                  ctx.key.remoteJid.split("@")[0]
                }\n*Hora de Mensaje:* ${moment().format(
                  "DD/MM/YYYY HH:mm"
                )}\n\nPor favor, contactarse lo antes posible. Gracias!`;
        ...
        Disabled: {
          ...
          onEntry: async (context, event) => {
            ...
            console.log(context.flowControl.isActive);
          },
          // after: {
